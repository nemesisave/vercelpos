...
const ProductGrid: React.FC<ProductGridProps> = ({ products, onAddToOrder, isLocked }) => {
      ...
      <div className="mb-6 space-y-4">
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2 pl-10 pr-12 text-text-primary bg-surface border border-border rounded-full focus:outline-none focus:ring-2 focus:ring-primary"
